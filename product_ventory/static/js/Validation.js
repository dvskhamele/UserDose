...
$("#already_exist_user").css("display", "none");
  ...
  $.ajax({
    url: "/accounts/check_if_user_exists/",
    data: {
          'username': username
        },
    dataType: 'json',
...
function validatePassword(e,csrf_token) {
...
function validateloginUsername() {
  ...
  $.ajax({
    ...
    console.log("data",data);
      if (data.message) {
                $("#not_an_exist_user").css("display", "none");
                $('#password').removeAttr("disabled");
                $("#signup").removeAttr("disabled");
      }else{
        $("#not_an_exist_user").css("display", "block");
        $("#not_an_exist_user").text("Email or Username does not exist");
